<?php
namespace Wdevs\InquireManager\Ui\Component;
...
/**
 * DataProvider for Inquire Manager UI.
 */
class DataProvider extends FrameworkDataProvider
{
    ...
    public function prepareMetadata()
    {
        ...
        if (!$this->getAuthorizationInstance()->isAllowed('Wdevs_InquireManager::create_customer')) {
            $metadata = [
                'account_inquire_columns' => [
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'editorConfig' => [
